...
class TestPageFeature:
    ...
    def test_happy_path_login(self):
        ...
        login_page.login_happy_path('sr@wp.pl', '123456789')
    ...
    def test_forget_password_function(self):
        login_page = Login(self.driver)
        login_page.login_forget_password('s.r@wp.pl')
    ...
    def test_forget_password_function_with_wrong_mail(self):
        login_page = Login(self.driver)
        login_page.login_reset_password_wrong_mail('srwp.pl')
    ...
    def test_empty_email_input(self):
        login_page = Login(self.driver)
        login_page.login_empty_email('123456789')
    ...
    def test_wrong_email_input(self):
        login_page = Login(self.driver)
        login_page.login_wrong_email('srwp.pl', '123456789')
